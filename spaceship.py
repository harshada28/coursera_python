...
class Ship:
    ...
    def shoot(self):
        ...
        print pos, self.angle, self.radius
...
def rock_spawner():
    ...
    angle_vel = -0.08#random.randrange(0, 1)    
    #print position, vel
...
a_rock = Sprite([WIDTH / 3, HEIGHT / 3], [0.3, 0.3], 0, SPRITE_ANGLE_VEL, asteroid_image, asteroid_info)
